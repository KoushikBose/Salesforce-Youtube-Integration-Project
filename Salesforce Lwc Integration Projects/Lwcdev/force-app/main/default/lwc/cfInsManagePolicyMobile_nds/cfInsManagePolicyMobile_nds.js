import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfInsManagePolicyMobile_nds extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-a1p8Z000006zOLxAAS"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00P8Z000021lLFOEAC").then(() =>{
                    //Loading Custom CSS.
                  })
                });
