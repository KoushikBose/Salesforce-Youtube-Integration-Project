import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfInsHeaderBillingInfo_nds extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-a1p8Z000006zOLvAAC"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00P8Z000021lLFMEAK").then(() =>{
                    //Loading Custom CSS.
                  })
                });
